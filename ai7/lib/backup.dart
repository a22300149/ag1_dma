    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Customtextfield("Nombre", Icon(Icons.account_circle)),
            Customtextfield(
                "Apellido paterno", Icon(Icons.switch_account_outlined)),
            Customtextfield("Apellido materno", Icon(Icons.switch_account)),
            Customtextfield("E-mail", Icon(Icons.mail_outline)),
            Customtextfield("No. Celular", Icon(Icons.phone)),
            Customtextfield("Contraseña", Icon(Icons.password)),
            Customtextfield("Confirmar contraseña", Icon(Icons.password)),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                CustomButton(Colors.blue, "Aceptar", _metodoUno),
                CustomButton(Colors.redAccent, "Cancelar", _metodoDos),
              ],
            ),
          ],
        ),
