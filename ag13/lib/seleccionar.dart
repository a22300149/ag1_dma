...
class _SeleccionarPageState extends State<SeleccionarPage> {
        ...
        if (result['status'] == 'success') {
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text('El registro ha sido actualizado correctamente.'),
              actions: [
                TextButton(
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: Text('Error'),
              content: Text('Hubo un problema al actualizar el registro.'),
              actions: [
                TextButton(
                  onPressed: () => Navigator.pop(context),
                  child: Text('Aceptar'),
    ...
    if (response.statusCode == 200) {
      ...
      if (result['status'] == 'success') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('El registro ha sido eliminado exitosamente.')),
        );
      } else {
        showDialog(
          context: context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Seleccionar, Actualizar o Eliminar Registro'),
      ),
      body: Padding(
